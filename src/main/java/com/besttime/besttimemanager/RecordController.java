...
public class RecordController {
    ...
    record recordItem(String recordId, String playerId, String eventId, String eventName, String addNowDate,
                      String recordTime, boolean recordFlag,
                      boolean bestFlag) {
    }
    ...
    @GetMapping("/recordlist/{playerId}/searchevent_inrecord")
    ...
    @GetMapping("searchevent_inrecord")
    String listRecords(Model model,
                       @RequestParam("playerId")String playerId,
                       @RequestParam("searchEventName")String searchEventName){
        List<RecordController.recordItem> recordItems = this.dao.searchEventInRecord(playerId,searchEventName);
        model.addAttribute("record", recordItems);
